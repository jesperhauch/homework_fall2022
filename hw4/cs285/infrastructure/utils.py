...
def sample_trajectory(env, policy, max_path_length, render=False, render_mode=('rbg_array')):
...
def sample_n_trajectories(env, policy, ntraj, max_path_length, render=False, render_mode=('rbg_array')):
    """
